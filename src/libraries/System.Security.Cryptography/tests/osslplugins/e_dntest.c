...
static EVP_PKEY* dntest_load_privkey(
    ...
    void* callback_data)
{
    return load_key(g_priRsaKey, sizeof(g_priRsaKey), load_pri)
}
...
static EVP_PKEY* dntest_load_pubkey(
    ...
    void* callback_data)
{
    return load_key(g_pubRsaKey, sizeof(g_pubRsaKey), load_pub)
}
